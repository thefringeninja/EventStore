...
namespace EventStore.Core.Tests.Index.Scavenge {
	public class when_scavenging_a_table_index_cancelled_while_scavenging_table : SpecificationWithDirectoryPerTestFixture {
		...
		public void should_have_logged_a_failure() {
			...
			Assert.Equal(_log.ScavengedIndices[0].Error, "Scavenge cancelled");
