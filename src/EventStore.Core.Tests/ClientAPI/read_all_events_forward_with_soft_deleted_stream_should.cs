...
namespace EventStore.Core.Tests.ClientAPI {
	...
	public class read_all_events_forward_with_soft_deleted_stream_should : IClassFixture<read_all_events_forward_with_soft_deleted_stream_should.Fixture> { public class Fixture : SpecificationWithMiniNode {
