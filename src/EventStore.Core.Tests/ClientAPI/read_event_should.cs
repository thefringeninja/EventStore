...
namespace EventStore.Core.Tests.ClientAPI {
	...
	public class read_event_should : SpecificationWithMiniNode {
		...
		public Task throw_if_stream_id_is_null() {
			return Assert.ThrowsAsync<ArgumentNullException>(() => _conn.ReadEventAsync(null, 0, resolveLinkTos: false));
		}

		[Fact, Trait("Category", "Network")]
		public Task throw_if_stream_id_is_empty() {
			return Assert.ThrowsAsync<ArgumentNullException>(() => _conn.ReadEventAsync("", 0, resolveLinkTos: false));
		}
