...
namespace EventStore.Core.Tests.Services.Storage.HashCollisions {
	...
	public class read_stream_events_backward_with_hash_collision : IClassFixture<read_stream_events_backward_with_hash_collision.Fixture> { public class Fixture : SpecificationWithDirectoryPerTestFixture {
