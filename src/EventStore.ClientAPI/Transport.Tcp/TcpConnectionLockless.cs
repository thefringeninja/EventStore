...
namespace EventStore.ClientAPI.Transport.Tcp {
	internal class TcpConnectionLockless : TcpConnectionBase, ITcpConnection {
		internal static async Task<ITcpConnection> CreateConnectingConnection(ILogger log,
			Guid connectionId,
			...
			var connection = new TcpConnectionLockless(log, connectionId, remoteEndPoint, onConnectionClosed, handlePackage, onError);
